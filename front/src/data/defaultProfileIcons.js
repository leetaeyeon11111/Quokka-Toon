...
export const DEFAULT_PROFILE_ICONS = [
  ...
  { id: 'a8-hero', label: '히어로', group: 'GENRE', groupLabel: '장르', imageUrl: '/avatars/quokka-ip-a8-hero.png' },
  { id: 'a9-sports', label: '스포츠', group: 'GENRE', groupLabel: '장르', imageUrl: '/avatars/quokka-ip-a9-sports.png' },
  { id: 'a10-sf', label: 'SF', group: 'GENRE', groupLabel: '장르', imageUrl: '/avatars/quokka-ip-a10-sf.png' },
