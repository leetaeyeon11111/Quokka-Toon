...
public enum DefaultProfileIcon {
    ...
    A8_HERO("a8-hero", "히어로", "GENRE", "장르", "/avatars/quokka-ip-a8-hero.png"),
    A9_SPORTS("a9-sports", "스포츠", "GENRE", "장르", "/avatars/quokka-ip-a9-sports.png"),
    A10_SF("a10-sf", "SF", "GENRE", "장르", "/avatars/quokka-ip-a10-sf.png"),
